...
class ProcessKeyValue:
    ...
    def process_input(self):
        ...
        enrichedDataFrame = jsonObject.enrichDataFrame(self.output_dir + "/RICH-" + self.file_name + ".csv")
        ...
        sparseBlock = enrichedDataFrame[enrichedDataFrame["AvgLineDensity"] <= 10]
        ...
        # Table component
        jsonObject.getTableTextByLine()
        if len(jsonObject.getTableDataFrame()) > 0:
            enrichedTableDataFrame = jsonObject.enrichTableDataFrame()
